...
const id = {
  ...
  viewer: {
    label: 'DIGID Jersey — International Retro',
    badge: '3D Product Demo',
    openDemo: 'Buka Demo 3D',
    hint: 'Geser untuk memutar. Cubit atau scroll untuk zoom.',
    loading: 'Memuat model 3D',
    canvasLabel: 'Model 3D interaktif DIGID Jersey — International Retro. Geser untuk memutar.',
    zoomIn: 'Perbesar',
    zoomOut: 'Perkecil',
...
const en: Copy = {
  ...
  viewer: {
    ...
    canvasLabel: 'Interactive 3D model of the DIGID Jersey — International Retro. Drag to rotate.',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
    reset: 'Reset view',
    spin: 'Auto-rotate',
